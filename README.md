...
- **Margin notes as data display** — each incoming token connects directly back to its five strongest source words, preserving the direction of contextual attention. A loose handwritten list at the page edge repeats those words independently; rough line lengths replace numeric percentages as the weight display.
